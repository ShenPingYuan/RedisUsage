...
namespace RedisUsage.Helpers
{
    ...
    public static class RedisHelper
    {
        ...
        static RedisHelper()
        {
            ...
            string cnn = configuration.GetValue<string>("RedisConfiguration");
            ...
            {
                rCnn = ConnectionMultiplexer.Connect("94.191.83.150:6379,password=2439739932");
            }
        }
